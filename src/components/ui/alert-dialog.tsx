...
const AlertDialogOverlay = <T extends ValidComponent = 'div'>(
  ...
  return (
    <AlertDialogPrimitive.Overlay
      class={cn(
        'fixed inset-0 z-50 bg-background/80 p-4 backdrop-blur-sm data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:fade-out-0 data-[expanded]:fade-in-0',
        local.class
      )}
      {...others}
    />
